...
The nested module release tag is `examples/rules/v0.1.0-beta.1`. The dependency version used in `go.mod` is `v0.1.0-beta.1`. The engine and this reusable module have separate module identities and release tags.
