...
The current beta is displayed as `beta-0.3` and versioned `v0.1.0-beta.3`. The tool installs from `github.com/kakj-go/go-inject/cmd/go-inject`. The nested reusable rules module is separately tagged `examples/rules/v0.1.0-beta.3`; consumers require `github.com/kakj-go/go-inject/examples/rules v0.1.0-beta.3`.
